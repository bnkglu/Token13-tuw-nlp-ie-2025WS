...
- Each person presented his progress.
- Discussed challenges faced during implementation and further steps.

- Berke:
    - Try POTATO with full data and gold data of RoBERTa.
    - Rule-based approach is concise and interpretable.
...
- Bilal:
    ...
    - one DL implementation. (Conduct a literature review for these implementations to see what can be done)
    - **Qualitative and Quantitative explanation of results.**
- EgeA:
    ...
    - **Qualitative and Quantitative explanation of results.**
- EgeO 
    - will make your implementation in both ways. 
